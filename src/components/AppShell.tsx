    ...
    <main className="mx-auto min-h-screen w-full max-w-none overflow-x-hidden px-3 py-6 sm:px-8 lg:max-w-6xl">
      <header className="mb-4 flex flex-wrap items-end justify-between gap-4">
        ...
        <a
          ...
          className="ml-auto inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border border-white/20 bg-white/10 text-white/90 transition-colors hover:bg-white/20"
        >
